  ...
  String _getPaymentStatus(Map<String, dynamic> payment, bool isOverdue) {
    ...
    if (payment['selected'] == true) {
      ...
      if (totalPenaltyReceived == 0) {
        ...
        return 'Partially Paid Penalty: ₹${totalPenaltyReceived.toStringAsFixed(2)}/₹${(penaltyAmount + alreadyReceivedPenalty).toStringAsFixed(2)}';
      }
    }
...
//           print("✅ Loan Balance: ₹$loanBalance");
//         });
//       }
//     } catch (e) {
//       if (mounted) {
...
//         return 'Partially Paid: ₹${dueReceived.toStringAsFixed(2)}/₹${dueAmount.toStringAsFixed(2)}';
//       } else {
//         return 'Fully Paid';
//       }
//     } else if (payment['unpaid'] == true) {
...
//         return 'Partially Paid Penalty: ₹${penaltyReceived.toStringAsFixed(2)}/₹${penaltyAmount.toStringAsFixed(2)}';
//       } else {
//         return 'Penalty Paid';
//       }
//     }
...
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(
//           content: Text('Penalty received cannot exceed ₹${_fixedPenaltyAmount.toStringAsFixed(2)}'),
//           backgroundColor: Colors.red,
//           duration: const Duration(seconds: 2),
//         ),
//       );
...
//     });
//
//     print("📊 Updated totals - Due: ₹$totalDue, Penalty: ₹$totalPenalty");
//     print("📊 Received - Due: ₹$totalDueReceived, Penalty: ₹$totalPenaltyReceived");
//   }
//
//   Future<void> _recordCollection() async {
//     if (_loanId == null) {
...
//                       ),
//                     const Text(
//                       '• Payment amounts stored in: due_received (for due) and penalty_received (for penalty)',
//                       style: TextStyle(
//                         fontSize: 12,
//                         color: Colors.blue,
//                       ),
